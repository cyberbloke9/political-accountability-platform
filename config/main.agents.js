...
module.exports = [
  // Codemachine agents
  {
    ...
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '01-architecture-agent.md'),
  },
  {
    id: 'plan-agent',
    name: 'Plan Agent',
    description: 'Analyzes requirements and generates comprehensive iterative development plans with architectural artifacts',
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '02-planning-agent.md'),
  },
  {
    id: 'task-breakdown',
    name: 'Task Breakdown Agent',
    description: 'Extracts and structures tasks from project plans into JSON format',
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '03-task-breakdown-agent.md'),
  },
  {
    id: 'context-manager',
    ...
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '04-context-manager-agent.md'),
  },
  {
    id: 'code-generation',
    name: 'Code Generation Agent',
    description: 'Generates code implementation based on task specifications and design artifacts',
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '05-code-generation-agent.md'),
  },
  {
    ...
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '06-task-validation-agent.md'),
  },
  {
    id: 'runtime-prep',
    name: 'Runtime Preparation Agent',
    description: 'Generates robust shell scripts for project automation (install, run, lint, test)',
    promptPath: path.join(promptsDir, 'puttamachine', 'agents', '07-runtime-preparation-agent.md'),
  },
  {
    id: 'git-commit',
    name: 'Git Commit Agent',
    description: 'Handles git commit operations and commit message generation',
    promptPath: path.join(promptsDir, 'puttamachine', 'workflows', 'git-commit-workflow.md'),
  },
  {
    id: 'cleanup-code-fallback',
    name: 'Cleanup Code Fallback File',
    description: 'Deletes .puttamachine/prompts/code_fallback.md if it exists',
    promptPath: path.join(promptsDir, 'puttamachine', 'workflows', 'cleanup-code-fallback-workflow.md'),
  },
  {
    id: 'plan-fallback',
    name: 'Plan Fallback Agent',
    description: 'Fixes and validates plan generation issues when plan-agent fails',
    promptPath: path.join(promptsDir, 'puttamachine', 'fallback-agents', 'planning-fallback.md'),
  },
  {
    id: 'task-fallback',
    name: 'Task Fallback Agent',
    description: 'Fixes and validates task breakdown issues when task-breakdown fails',
    promptPath: path.join(promptsDir, 'puttamachine', 'fallback-agents', 'task-breakdown-fallback.md'),
  },
  ...
  // Dev puttamachine agents
  {
    id: 'init',
    name: 'Init',
    description: 'Initializes puttamachine development environment (creates branch and updates .gitignore)',
    promptPath: path.join(promptsDir, 'dev-puttamachine', 'main-agents', '00-init.md'),
  },
  {
    ...
    promptPath: path.join(promptsDir, 'dev-puttamachine', 'main-agents', '01-principal-analyst.md'),
  },
  {
    ...
    promptPath: path.join(promptsDir, 'dev-puttamachine', 'main-agents', '02-specifications-indexer.md'),
  },
  {
    ...
    promptPath: path.join(promptsDir, 'dev-puttamachine', 'main-agents', '04-blueprint-orchestrator.md'),
  },
  ...
  //  id: 'puttamachine',
  //  name: 'Codemachine',
  //  description: 'Core puttamachine workflow agents',
  //  folderPath: path.join(promptsDir, 'puttamachine'),
  //},
];
