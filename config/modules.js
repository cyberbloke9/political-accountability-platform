...
module.exports = [
  {
    ...
    promptPath: path.join(promptsDir, 'templates', 'puttamachine', 'workflows', 'task-verification-workflow.md'),
    behavior: {
      type: 'loop',
      action: 'stepBack',
    },
  },
  {
    ...
    promptPath: path.join(promptsDir, 'templates', 'puttamachine', 'workflows', 'iteration-verification-workflow.md'),
    behavior: {
      type: 'trigger',
