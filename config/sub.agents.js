module.exports = [
  ...
  // dev-puttamachine sub-agents
  {
    id: 'founder-architect',
    name: 'Founder Architect',
    description: 'Handle foundational architecture tasks',
    mirrorPath: 'prompts/templates/dev-puttamachine/sub-agents/architecture/01-founder-architect.md',
  },
  {
    ...
    mirrorPath: 'prompts/templates/dev-puttamachine/sub-agents/architecture/02-structural-data-architect.md',
  },
  {
    ...
    mirrorPath: 'prompts/templates/dev-puttamachine/sub-agents/architecture/03-behavior-architect.md',
  },
  {
    id: 'ui-ux-architect',
    ...
    mirrorPath: 'prompts/templates/dev-puttamachine/sub-agents/architecture/05-ui-ux-architect.md',
  },
  {
    ...
    mirrorPath: 'prompts/templates/dev-puttamachine/sub-agents/architecture/04-operational-architect.md',
  },
  {
    id: 'file-assembler',
    name: 'File Assembler',
    description: 'Execute commands and create manifest files from architecture outputs',
    mirrorPath: 'prompts/templates/dev-puttamachine/sub-agents/architecture/06-file-assembler.md',
  }
];
