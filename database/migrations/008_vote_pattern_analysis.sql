-- Migration: Vote Pattern Analysis (Multi-Party System)
...
CREATE TABLE IF NOT EXISTS vote_history (
  ...
  politician_id UUID, -- Denormalized for faster queries
...
BEGIN
  -- Get politician info from the verification
  SELECT
    p.politician_id,
    pol.party
  INTO politician_record
